...
class Button1(discord.ui.View):
    ...
    async def button_callback(self, button: discord.ui.Button, interaction: discord.Interaction):
        embed = discord.Embed(title="Auto server setup",
                              description="Here u can fully set up your discord server with 5 clicks", color=0x001eff)
        embed.add_field(name="----------------------------------------------------------------", value="", inline=False)
        embed.add_field(name="Channels - Click this to create all channels u need on your server", value="",
                        inline=False)
        embed.add_field(name="----------------------------------------------------------------", value="", inline=False)
...
async def settings(ctx):
    embed = discord.Embed(title="Main server settings", description="Here u can select category with u interested in.",
                          color=0x001eff)
    embed.set_footer(text="AsmekBOT[ALFA] 2023")
...
async def ping(ctx):
    ...
    embed = discord.Embed(title="Pong! ",
                          description="Here u can see basic parameters like ping or percent of used cpu. ",
                          color=0x0000ff)
